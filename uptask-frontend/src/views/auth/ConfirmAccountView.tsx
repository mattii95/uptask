...
export default function ConfirmAccountView() {
    const [code, setCode] = useState<Confirm2FA['two_factor_code']>('')
    ...
    const handleChange = (code: Confirm2FA['two_factor_code']) => {
        setCode(code)
    }

    const handleComplete = (code: Confirm2FA['two_factor_code']) => mutate({ two_factor_code: code })
